        ...
        <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center py-12">
              ...
              <button
                onClick={() => router.push('/student/supervisors')}
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8">
              <div className="flex items-start justify-between gap-6">
                {/* Profile Picture */}
                <div className="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0 bg-white/20 flex items-center justify-center">
                  {supervisor.profilePicture ? (
                    ...
                    <div className="w-full h-full bg-blue-500 flex items-center justify-center text-white font-bold text-4xl">
                ...
                <div className="text-right">
                  <div
                    className={`inline-block px-4 py-2 rounded-full text-sm font-semibold ${isAvailable
            ...
            <div className="p-8">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className={`flex-1 py-3 px-6 rounded-lg font-semibold transition-all ${isAvailable && !isSubmitting
